...
1. [Overview](#overview)
  ...
  1. [REST](#rest)
  1. [Resource](#resource)
1. [Markup Language](#markup-language)
  1. [Includes](#includes)
1. [Named Parameters](#named-parameters)
  1. [displayName](#displayname)
  1. [description](#description)
  1. [type](#type)
      1. [Date Representations](#date-representations)
  1. [enum](#enum)
  1. [pattern](#pattern)
  ...
  1. [required](#required)
  1. [default](#default)
1. [Named Parameters With Multiple Types](#named-parameters-with-multiple-types)
1. [Basic Information](#basic-information)
  1. [Root Section](#root-section)
  1. [API Title](#api-title)
  1. [API Version](#api-version)
  1. [Base URI and baseUriParameters](#base-uri-and-baseuriparameters)
  1. [Protocols](#protocols)
  1. [Default Media Type](#default-media-type)
  1. [Schemas](#schemas)
  1. [URI Parameters](#uri-parameters)
  1. [User Documentation](#user-documentation)
  1. [Resources and Nested Resources](#resources-and-nested-resources)
    1. [Display Name](#display-name)
    1. [Description](#description)
    1. [Template URIs and URI Parameters](#template-uris-and-uri-parameters)
    1. [Base URI parameters](#base-uri-parameters)
    1. [Absolute URI](#absolute-uri)
    1. [Methods](#methods)
      ...
      1. [Query Strings](#query-strings)
        1. [Example](#example-1)
      1. [Body](#body)
        1. [Web Forms](#web-forms)
        1. [Example](#example-2)
        1. [Schema](#schema)
        1. [Example](#example-3)
      1. [Responses](#responses)
        1. [Headers](#headers-1)
  1. [Resource Types and Traits](#resource-types-and-traits)
    1. [Declaration](#declaration)
1. [%RAML 0.8](##%raml-08)
  1. [Usage](#usage)
  1. [Parameters](#parameters)
  1. [Optional Properties](#optional-properties)
  1. [Applying Resource Types and Traits](#applying-resource-types-and-traits)
1. [Security](#security)
  1. [Declaration](#declaration-1)
      1. [Description](#description-2)
      1. [Type](#type)
      1. [describedBy](#describedby)
      1. [Settings](#settings)
        1. [OAuth 1.0](#oauth-10)
        1. [OAuth 2.0](#oauth-20)
        1. [Other](#other)
  1. [Usage: Applying a Security Scheme to an API](#usage-applying-a-security-scheme-to-an-api)
